...
export const HomeView: React.FC = () => {
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-6xl mx-auto space-y-6 sm:space-y-8 text-xs font-sans">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-white/10 pb-6">
        ...
        <div className="flex flex-wrap items-center gap-2 shrink-0">
          <button
            ...
            className="px-3.5 py-2 rounded-xl bg-cyan-500 hover:bg-cyan-400 text-slate-950 font-bold font-mono text-xs flex items-center gap-1.5 shadow-lg shadow-cyan-500/20 transition-all cursor-pointer"
          >
          ...
          <button
            ...
            className="px-3.5 py-2 rounded-xl bg-white/5 hover:bg-white/10 text-slate-200 border border-white/10 font-mono font-semibold text-xs flex items-center gap-1.5 transition-colors cursor-pointer"
          >
          ...
          <button
            ...
            className="px-3.5 py-2 rounded-xl bg-indigo-500/10 hover:bg-indigo-500/20 text-indigo-300 border border-indigo-500/30 font-mono font-bold text-xs flex items-center gap-1.5 transition-all cursor-pointer"
          >
      ...
      {/* B. Continue Working / Empty Workspace State */}
      {overview.continueWorkflow ? (
        ...
        <div className="p-8 rounded-3xl bg-black/40 border border-white/10 backdrop-blur-xl text-center space-y-5">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 pt-2">
            <button
              onClick={() => setShowCreateModal(true)}
              className="px-4 py-2.5 rounded-xl bg-cyan-500 hover:bg-cyan-400 text-slate-950 font-bold font-mono text-xs flex items-center gap-2 shadow-lg shadow-cyan-500/20 transition-all cursor-pointer"
            >
              <Plus className="w-4 h-4" />
              <span>Create Workflow</span>
            </button>
            <button
              onClick={() => setShowImportModal(true)}
              className="px-4 py-2.5 rounded-xl bg-white/5 hover:bg-white/10 text-slate-200 border border-white/10 font-mono font-semibold text-xs flex items-center gap-2 transition-colors cursor-pointer"
            >
            ...
            <button
              onClick={() => setShowAiModal(true)}
              className="px-4 py-2.5 rounded-xl bg-indigo-500/10 hover:bg-indigo-500/20 text-indigo-300 border border-indigo-500/30 font-mono font-bold text-xs flex items-center gap-2 transition-all cursor-pointer"
            >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="p-5 sm:p-6 rounded-3xl bg-black/30 border border-white/10 backdrop-blur-xl space-y-4">
          ...
          <div className="space-y-2.5">
            <button
              onClick={() => setShowCreateModal(true)}
              className="w-full p-3.5 rounded-2xl bg-white/5 hover:bg-white/10 border border-white/10 text-left transition-all group cursor-pointer flex items-center justify-between gap-3"
            >
      ...
      <div className="p-5 sm:p-6 rounded-3xl bg-black/30 border border-white/10 backdrop-blur-xl space-y-4">
        <div className="flex items-center justify-between border-b border-white/10 pb-3">
          ...
          <button
            ...
            className="text-[11px] font-mono text-cyan-400 hover:text-cyan-300 font-semibold flex items-center gap-1 transition-colors cursor-pointer"
          >
              ...
              >
                ...
                <div className="flex items-center gap-2 shrink-0">
                  <button
                    ...
                    className="px-3.5 py-1.5 rounded-xl bg-cyan-500 hover:bg-cyan-400 text-slate-950 font-bold font-mono text-xs flex items-center gap-1.5 transition-all cursor-pointer shadow-md shadow-cyan-500/10"
                  >
                    <span>Open</span>
                    <ArrowRight className="w-3.5 h-3.5" />
                  </button>
